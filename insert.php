<?php
session_start();
$user_num=$_REQUEST['user_number'];									// Maintaining the session id of the sender and reciever
...
if(!$con){
	...
	die("Connection Failed!!!".mysqli_connect_error());
			...
			// These queries are used to retrieve the chat logs and also display the current chat to the user
